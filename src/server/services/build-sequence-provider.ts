        ...
        const aiResult = await provider.generateDraft({
          ...
          context: {
            ...
            writingInstructions: [
              ...
              "Treat retrieved CASE_STUDY records as approved Primelis outbound proof. Use one relevant case study in step 2 or step 3 when any case study matches the industry/persona. Do not force social proof into step 1.",
