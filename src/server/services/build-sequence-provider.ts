        ...
        const aiResult = await provider.generateDraft({
          ...
          context: {
            ...
            writingInstructions: [
              ...
              "Use social proof in step 2 or step 3 when approvedKnowledge contains an externally usable CASE_STUDY relevant to the industry/persona. Do not force social proof into step 1.",
              "Only mention a named customer, savings percentage, MQL, SQL, revenue, clicks, or performance metric if that exact claim appears in approvedKnowledge or approvedFacts with no usage restriction.",
              "If an approved metric exists, make it concrete and compact: e.g. reduced branded-search spend while keeping overall performance, revenue and clicks stable; or lowered cost per MQL/SQL while maintaining lead quality.",
              ...
              "If the user asks for 40-60% savings but no approved 40-60% metric is available, do not invent it. Say 'similar teams look for meaningful savings while protecting performance' instead of using an exact number.",
