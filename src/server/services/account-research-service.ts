    ...
    await this.client.$executeRaw`
      ...
      VALUES (
        ...
        ${JSON.stringify({
          ...
          stakeholderRecommendations: result.stakeholderRecommendations,
        })}::jsonb,
        ${JSON.stringify({
          ...result.angleRecommendation,
          openQuestions: result.openQuestions,
          likelyOpportunities: result.likelyOpportunities,
          downstreamHandoff: result.downstreamHandoff,
        })}::jsonb,
...
export async function assessAccountResearch(
  ...
  const resultWithoutId: Omit<AccountAssessmentResult, "assessmentId"> = {
    ...
    stakeholderRecommendations: built.stakeholderRecommendations,
    angleRecommendation: built.angleRecommendation,
    openQuestions: built.openQuestions,
    likelyOpportunities: built.likelyOpportunities,
    claimsToAvoid: built.claimsToAvoid,
    structuredResearch: built.structuredResearch,
    downstreamHandoff: built.downstreamHandoff,
