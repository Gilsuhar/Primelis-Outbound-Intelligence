...
function sourceText({
  ...
  return [
    ...
    ...[
      ...
      ...intelligence.contextInterpretation.historicalExperience,
      ...intelligence.contextInterpretation.historicalCompanies,
      ...intelligence.contextInterpretation.credibilitySignals,
      ...intelligence.contextInterpretation.personalBackground,
      ...intelligence.contextInterpretation.commercialSignals,
      ...intelligence.contextInterpretation.uncertainFacts,
    ].flatMap((item) => [item.text, item.groundingReference]),
            ...
            content: [
              {
                ...
                text: JSON.stringify({
                  ...
                  prospectContext: {
                    ...
                    contextInterpretation: request.intelligence.contextInterpretation,
