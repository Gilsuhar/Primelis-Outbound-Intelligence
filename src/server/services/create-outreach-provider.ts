        ...
        const aiResult = await provider.generateDraft({
          ...
          context: {
            ...
            writingInstructions: [
              ...
              "Treat retrieved CASE_STUDY records as approved Primelis outbound proof. Use one relevant case study only when it strengthens the draft and matches the industry/persona.",
