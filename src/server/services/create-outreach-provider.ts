        ...
        const aiResult = await provider.generateDraft({
          ...
          context: {
            ...
            writingInstructions: [
              ...
              "Use social proof only when approvedKnowledge contains an externally usable CASE_STUDY relevant to the industry/persona.",
              ...
              "If an approved metric exists, make it concrete and compact: reduced branded-search spend while keeping overall performance, revenue and clicks stable; or lowered cost per MQL/SQL while maintaining lead quality.",
              ...
              "If the user asks for 40-60% savings but no approved 40-60% metric is available, do not invent it. Use 'meaningful savings while protecting performance' instead.",
